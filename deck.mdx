...
- Others adopted Functional CSS approach
- Same concept
- Similar APIs
...
- Different naming conventions
- Design tokens from one system are not likely to work in another system
...
- What is Gatsby?
  - Modern framework for building Progressive Web Apps
...
- Moral of this story
- Don't overthink it
- Just call it what everyone else does
